...
class E2ETestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.category = Category.objects.create(name="Categoria Teste", slug="categoria-teste")
    ...
    def test_post_list_by_category(self):
        ...
        response = self.client.get(reverse("post_list_by_category", args=[self.category.slug]))
        self.assertEqual(response.status_code, 200)
    ...
    def test_post_list_by_author(self):
        ...
        response = self.client.get(reverse("post_list_by_author", args=[self.user.username]))
        self.assertEqual(response.status_code, 200)
